...
// Filter proyeksi batch kini hidup di ScreenRail (sidebar kanan) — lihat
// components/ScreenRail.vue. Halaman ini fokus ke chart & detail saham.
...
<template>
  <div class="pb-16 bg-slate-950 text-slate-100 flex flex-col flex-grow">
    <main class="max-w-7xl mx-auto px-4 sm:px-6 mt-8 flex-grow w-full space-y-6">
      ...
      <!-- Filter proyeksi batch kini di sidebar kanan (ScreenRail) -->
